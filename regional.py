...
path = "data/ice.zip"
path = 'Data/gtfs_fp2024_2024-10-24_filtered.zip'
path = 'Data/zurich_filtered.zip'
...
path_reg = 'Data/gtfs_fp2024_2024-10-24.zip'

feed_reg = pt.get_representative_feed(path_reg)
#Just specifying a time period between which you can get the statistics - this can be modified based on the stop_times.txt file
#%%
start = 0*0*0  # 7:00 AM
end = 7*60*60 + 0*0*0 # 10:00 AM
...
dataset = MyOwnDataset(root="testoutput", nx_graphs=[G_ice, G_reg])
# %%
